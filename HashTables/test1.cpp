...
bool test1() {
  ...
  if (N.getKey() != "AC21008" || N.getValue() != 21008) {
    cout << "Hash Node values are not stored correctly 1";
    return false; 
  }
  ...
  T2.insert("AAA",42);
  T2.insert("A",76);
  cout << "AAAA: "<< T2.getValue("AAAA") << endl;
  cout << "AAA: "<< T2.getValue("AAA") << endl;
  cout << "A: "<< T2.getValue("A") << endl;
  ...
  if (N2.getKey() != "AC21008" || N2.getValue() != "21008") {
    cout << "Hash Node values are not stored correctly 2";
    return false; 
  }
  ...
  if (T3.getValue("Hello") != "17" || T3.getValue("abc")!= "12" || T3.getValue("World") != "19") {
    cout << "String values are not stored correctly 1." << endl;
    return false;
  }
  ...
  if (T4.getValue("AAAA") != "39" || T4.getValue("A") != "76" || T4.getValue("AAA") != "42") {
    cout << "String values are not stored correctly 2." << endl;
    return false;
  } 
